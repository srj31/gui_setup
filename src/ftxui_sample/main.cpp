...
// configuration step. It creates a namespace called `gui_setup`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", gui_setup::cmake::project_name, gui_setup::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", gui_setup::cmake::project_version);
      return EXIT_SUCCESS;
    }
